...
[EXPERIMENT_TEMPLATE.md](EXPERIMENT_TEMPLATE.md), including the failure result
...
[DATA_AND_LABELS.md](DATA_AND_LABELS.md). Include:
...
Use [FEATURE_LIBRARY.md](FEATURE_LIBRARY.md) for formulas, parameter axes,
...
Read [VISUAL_GUIDE.md](VISUAL_GUIDE.md) for cluster shapes.
...
model-free test from [EXPERIMENT_CATALOG.md](EXPERIMENT_CATALOG.md):
...
Run `E53-E58` and [VALIDATION_AND_COSTS.md](VALIDATION_AND_COSTS.md):

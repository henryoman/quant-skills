...
fixed decision rule. Use [experiment-template.md](experiment-template.md) for
...
- Setup: apply every invariant and metadata requirement in
  [data-and-labels.md](data-and-labels.md).
- Varied: none.
...
- Reject: isolated hot pixel, edge-only sparse cells, or color driven by a few
  overlapping events. See [visual-guide.md](visual-guide.md).
